...
export function ResumeUpload({ onUploadComplete, user }) {
  ...
  return (
    <div className="rounded-2xl border border-white/15 bg-[#081f26]/85 p-5 backdrop-blur-lg">
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-3 rounded-xl border border-[#4ade80]/30 bg-[#4ade80]/10 p-4">
            ...
            <div>
              ...
              <p className="text-sm text-white/60">
                Your profile is being used for matching
              </p>
            </div>
          </div>
          ...
          {parsedData?.education && (
            <div className="rounded-xl border border-white/10 bg-[#05161b]/90 p-4">
              <h4 className="mb-2 text-sm font-bold uppercase tracking-wider text-white/70">
                Extracted Info
              </h4>
              <div className="space-y-2 text-sm text-white/80">
                <p>
                  <span className="text-white/50">Degree:</span>{" "}
                  {parsedData.education.degree || "N/A"}
                </p>
                <p>
                  <span className="text-white/50">Branch:</span>{" "}
                  {parsedData.education.branch || "N/A"}
                </p>
                <p>
                  <span className="text-white/50">Year:</span>{" "}
                  {parsedData.education.year || "N/A"}
                </p>
